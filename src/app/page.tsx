...
import HomePageSectionFour from "@/components/page/home/HomePageSectionFour";
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      ...
      {/* Section 04 */}
      <HomePageSectionFour></HomePageSectionFour>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="basis-1/2 p-4 pb-0 md:pb-4">
            ...
            <EventCard
              ...
              date={"15"}
              month={"October"}
              subtitle={"We'll notify the acceptance of your papers."}
            ></EventCard>
            <EventCard
