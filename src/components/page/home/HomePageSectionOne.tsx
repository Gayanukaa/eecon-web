            ...
            <div className="divide-y overflow-scroll scrollbar-track-red scrollbar-thumb-red">
              ...
              <div className="p-4 sm:p-4 pl-6 ">
                ...
                <p className="text-black pt-3 pl-4">
                  ...
                  participants to expert knowledge and the opportunity to
                  discuss novel trends and scientific contributions in all
          ...
          <div className="col-span-1 bg-white p-6 h-100 drop-shadow-lg ">
            <div className="max-h-screen overflow-scroll scrollbar-track-red scrollbar-thumb-red">
              ...
              <p className="text-gray-700 italic text-sm">
                ...
                technologies in different Engineering disciplines for the
                betterment of fields of Electrical Engineering.
              </p>
              <h2 className="mt-8 text-xl text-black font-semibold mb-2 text-transform: uppercase ">
                Mission
              </h2>
              <p className="text-gray-700 italic text-sm">
                To create a stage for researchers around the world to
                disseminate knowledge in the disciplines of Electrical,
                Instrumentation and Control, Electronics engineering, Computer
                Science & Engineering, Industrial Engineering and Information
                Technology for integration of diverse engineering solutions that
                are socially, economically and environmentally sustainable for
                the betterment of fields of Electrical Engineering.
              </p>
              <h2 className="mt-8 text-xl text-black font-semibold mb-2 text-transform: uppercase ">
                Scope
              </h2>
              <p className="text-gray-700 italic text-sm">
                ...
                topics in Electrical Engineering. Topics of interest include,
